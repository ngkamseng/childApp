...
const Page2 = () => {
  const counter = useAppSelector(state => state.ChildApp_transaction.counter)
  const {userId, token } = useAppSelector(state => state.ChildApp_login)
      ...
      <SafeAreaView>
        <ScrollView contentInsetAdjustmentBehavior="automatic">
          <View style={commonStyles.container}>
            <View>
              <Text style={commonStyles.titles}>ChildApp Page 2</Text>
            </View>
